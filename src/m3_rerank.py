...
class CrossEncoderReranker:
    ...
    def rerank(self, query: str, documents: list[dict], top_k: int = RERANK_TOP_K) -> list[RerankResult]:
        ...
        # Cross-encoder đọc CẢ CẶP (query, doc) cùng lúc → chính xác hơn bi-encoder,
        # đổi lại phải chạy 1 forward pass cho mỗi document.
...
if __name__ == "__main__":
    ...
    print(f"Latency: avg {stats['avg_ms']:.1f}ms (min {stats['min_ms']:.1f} / max {stats['max_ms']:.1f})")
